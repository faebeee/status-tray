...
import { MinimalProject } from '../minimal-project.tsx';
...
export const MinimalGitRepo = ({ owner, repo }: RepositoryProps) => {
  ...
  return <MinimalProject title={`${owner}/${repo}`} workflows={workflows} />
};
